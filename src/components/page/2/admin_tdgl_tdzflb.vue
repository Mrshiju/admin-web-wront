  ...
  <div class="container">
    <el-form inline="inline" label-width="120px" v-on:keyup.enter.native="checkData">
      ...
      <el-form-item label="运营商：">
        <el-select v-model="operaid">
          <el-option v-for="(item,i) of gwList" :label="item.label" :value="item.value" :key="i"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-card v-if="checkIn">
      ...
      <el-table border ref="table" v-loading="loading" :data="tableData" stripe>
        ...
        <el-table-column prop="feeMethod" label="计费方式"></el-table-column>
        <el-table-column prop="operator_id" label="运营商"></el-table-column>
        <el-table-column prop="begin_count" label="大于等于"></el-table-column>
        <el-table-column prop="end_count" label="小于等于"></el-table-column>
        <el-table-column prop="price" label="费率"></el-table-column>
        ...
        <el-form :model="addData" label-width="120px" style="width: 400px">
          <el-form-item label="通道名称：">
            <el-select v-model="addData.gatewayName" @change="change">
              <el-option v-for="(item,i) of gatewayList" :label="item.label" :value="item.value" :key="i"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="通道编号：">
...
export default {
  ...
  methods: {
    ...
    checkData() {
      ...
      this.loading = true;
      let self = this;
      this.postRequest("admin/listFinanceAttribute", {
